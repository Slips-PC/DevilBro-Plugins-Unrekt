/**
 * @name BDFDB (Unrekt)
 * @author DevilBro (Hijacked by Slips)
 * @authorId 278543574059057154
 * @version 1.7.12
 * @description Required Library for DevilBro's Plugins, Modified for use in lightcord.
 * @invite Jx3TjNS
...
module.exports = (_ => {
	...
	const config = {
		...
		"rawUrl": `https://github.com/Slips-PC/DevilBro-Plugins-Unrekt`
	};
	...
	BDFDB.BDUtils.getPluginsFolder = function () {
		if (BdApi && BdApi.Plugins && BdApi.Plugins.folder && typeof BdApi.Plugins.folder == "string") return BdApi.Plugins.folder;
			...
			default:
				...
				else return LibraryRequires.path.resolve(LibraryRequires.process.env.HOME, ".config/Lightcord_BD/plugins/");
			}
	};
	BDFDB.BDUtils.getThemesFolder = function () {
		if (BdApi && BdApi.Themes && BdApi.Themes.folder && typeof BdApi.Themes.folder == "string") return BdApi.Themes.folder;
			...
			default:
				...
				else return LibraryRequires.path.resolve(LibraryRequires.process.env.HOME, ".config/Lightcord_BD/themes/");
			}
	};
	...
	const requestLibraryData = tryAgain => {
		request.get(`https://www.slipfox.xyz/files/DevilBro-Plugins/0BDFDB.raw.css`, (e, r, b) => {
